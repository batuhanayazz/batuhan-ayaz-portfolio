export const Bio = {
  ...
  facebook: "https://www.facebook.com/Batuhan.Ayaz123/",
};
...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "Apiary",
        image: "https://www.vectorlogo.zone/logos/apiaryio/apiaryio-icon.svg",
      },
      {
        name: "Firebase",
...
export const experiences = [
  {
    id: 0,
    img: "https://anivia.be/_next/image?url=%2Fassets%2Fimgs%2Flogos%2Fbrands%2Fbrand-3.png&w=3840&q=75",
    role: "UI/UX Designer and tester",
    company: "Entego BV",
    date: "Aug 2021 - Okt 2021",
    desc: "Created designs in Adobe XD to address issues with an Android and iOS application and Websites.Contributed to improving the overall user experience of the app.Tested the software to ensure functionality and identify potential problems.Used attention to detail and troubleshooting skills to identify and resolve bugs or errors.",
    skills: [
      "Docker",
      "JavaScript",
      "TypeScript",
  ...
  {
    id: 1,
    img: "https://anivia.be/_next/image?url=%2Fassets%2Fimgs%2Flogos%2Flogo.png&w=128&q=75",
    role: "Full Stack Developer and tester",
    company: "Anivia BV",
    date: "May 2022 - Aug 2022",
    desc: "As a Full Stack Developer and Tester, I had the pleasure of working on the ANIVIA project, which involved creating the Venus Kebap website (www.venuskebap.com) . This project showcased my expertise in React.js, Node.js, and Docker, and it was a remarkable collaboration under the ANIVIA company.",
    skills: [
      "Docker",
      "JavaScript",
      "TypeScript",
